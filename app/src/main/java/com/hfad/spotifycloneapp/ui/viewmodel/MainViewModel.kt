...
import com.hfad.spotifycloneapp.exoplayer.isPlayEnabled
import com.hfad.spotifycloneapp.exoplayer.isPlaying
import com.hfad.spotifycloneapp.exoplayer.isPrepared
        ...
        musicServiceConnection.subscribe(
            ...
            object : MediaBrowserCompat.SubscriptionCallback() {
                override fun onChildrenLoaded(
                    ...
                    Log.d("MainViewModel", "Received songs: ${items.size}")
